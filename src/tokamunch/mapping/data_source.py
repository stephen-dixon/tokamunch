"""TokamapInterface: unified API over a mapper for querying values and array lengths."""
...
from ..plugins.api import MapperProtocol
...
# Shared with mapping/runner.py for consistent error classification.
...
class TokamapInterface:
    def __init__(
        ...
        *,
        ...
        # Set externally to enable per-call timing (see core/profiling.py).
